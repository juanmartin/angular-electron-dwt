...
function InitMessageBody() {
    ...
    if (MessageBody) {
        var ObjString = "<div><p>Platform & Browser Support: </p>Internet Explorer 9 or above (32 bit/64 bit), any version of Chrome (32 bit/64 bit), any version of Firefox on Windows; Safari, Chrome and Firefox on Mac OS X 10.7 or later; Chrome and Firefox v27 or above (64 bit) on Ubuntu 16.04+, Debian 8+";
        ObjString += ".</div>";
